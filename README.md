...
Мы собрали список известных диапазонов IP популярных сканирующих систем и сервисов сбора данных. Скрипт автоматически создаёт правила блокировки входящего трафика от этих адресов через `iptables` и `ipset`.
